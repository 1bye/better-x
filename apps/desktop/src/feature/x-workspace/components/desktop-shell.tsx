...
import { useDesktopShellState } from "../hooks/use-desktop-shell-state.js";
import type { DesktopShellState } from "../lib/desktop-api.js";
...
export function DesktopShell(): ReactElement {
  ...
  const state = useDesktopShellState();
